...
See [ARCHITECTURE.md](ARCHITECTURE.md) for the layers, the conservation contract, the save/load format, and the four-bucket sweep method. The product vision is in [DESIGN-VISION.md](DESIGN-VISION.md).
