...
### In-Repo Docs
- **Full dev guide**: `CONTRIBUTING.md`
- **Architecture overview**: `docs/architecture/quick_overview.md`
- **Lessons learned**: `docs/architecture/phase1-lessons-learned.md`
- **Build/release**: `docs/BUILD_GUIDE.md`
- **5-min setup**: `getting_started_developing.md`

### GitBook (`gitbook/for-developers/architecture/`)
- `comprehensive-architecture-overview.md` - Full Layer 4 architecture
- `interaction-system-architecture.md` - Flow lifecycle, 4-stage state machine
- `visual-system-architecture.md` - Rendering, z-order, curves
- `decisions/adr-001-signal-pattern.md` - Memo::new vs Signal::derive decision
